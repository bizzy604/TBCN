...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, swaggerConfig, document_1, port;
                ...
                case 1:
                    ...
                    if (configService.get('NODE_ENV') !== 'production') {
                        swaggerConfig = new swagger_1.DocumentBuilder()
                            ...
                            .setDescription('RESTful API for The Brand Coach Network platform - Learning, Coaching, Community, Commerce')
                            .setVersion('1.0')
                            .addBearerAuth({
                            type: 'http',
                            scheme: 'bearer',
