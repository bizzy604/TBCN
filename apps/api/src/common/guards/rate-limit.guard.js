 ...
 */
var RateLimitGuard = /** @class */ (function (_super) {
    __extends(RateLimitGuard, _super);
    function RateLimitGuard() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RateLimitGuard.prototype.throwThrottlingException = function () {
        throw new throttler_1.ThrottlerException('Too many requests. Please try again later.');
    };
    /**
     * Get tracker key (IP address by default)
     */
    RateLimitGuard.prototype.getTracker = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, req.ip];
            });
        });
    };
